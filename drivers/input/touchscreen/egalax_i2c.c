...
#define RELEASE_DATE "2022/06/23"
...
#define I2C_BUS_NUMBER		7			//TODO: modify to set your I2C Bus
...
static unsigned int DbgLevel = DBG_MODULE|DBG_SUSP|DBG_POINT;
